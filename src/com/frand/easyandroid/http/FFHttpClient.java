...
public class FFHttpClient {
	...
	public FFHttpClient() {
		...
		httpClient.setHttpRequestRetryHandler(new FFRetryHandler(
				DEFAULT_MAX_RETRIES));
	 ...
	 */
	public void get(int reqTag, String url, FFHttpRespHandler responseHandler) {
		get(null, reqTag, url, null, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void get(int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		get(null, reqTag, url, params, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void get(Context context, int reqTag, String url,
			FFHttpRespHandler responseHandler) {
		get(context, reqTag, url, null, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void get(Context context, int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		sendRequest(httpClient, httpContext,
				new HttpGet(getUrlWithQueryString(url, params)), null,
				responseHandler, context, reqTag, getUrlWithQueryString(url, params));
	}

	//
	// HTTP download Requests
	//
	public void download(int reqTag, String url, FFHttpRespHandler responseHandler) {
		download(null, reqTag, url, null, responseHandler);
	}

	public void download(int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		download(null, reqTag, url, params, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void download(Context context, int reqTag, String url,
			FFHttpRespHandler responseHandler) {
		download(context, reqTag, url, null, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void download(Context context, int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		sendRequest(httpClient, httpContext,
				new HttpGet(getUrlWithQueryString(url, params)), null,
				responseHandler, context, reqTag, getUrlWithQueryString(url, params));
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void get(Context context, int reqTag, String url, Header[] headers,
			FFRequestParams params, FFHttpRespHandler responseHandler) {
		HttpUriRequest request = new HttpGet(getUrlWithQueryString(url, params));
		if (headers != null)
			request.setHeaders(headers);
		sendRequest(httpClient, httpContext, request, null, responseHandler,
				context, reqTag, getUrlWithQueryString(url, params));
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void post(int reqTag, String url, FFHttpRespHandler responseHandler) {
		post(null, reqTag, url, null, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void post(int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		post(null, reqTag, url, params, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void post(Context context, int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		post(context, reqTag, url, paramsToEntity(params), null, responseHandler, getUrlWithQueryString(url, params));
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void post(Context context, int reqTag, String url, HttpEntity entity,
			String contentType, FFHttpRespHandler responseHandler, String reqUrl) {
		sendRequest(httpClient, httpContext,
				addEntityToRequestBase(new HttpPost(url), entity), contentType,
				responseHandler, context, reqTag, reqUrl);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void post(Context context, int reqTag, String url, Header[] headers,
			FFRequestParams params, String contentType,
			FFHttpRespHandler responseHandler) {
	...
	public void post(Context context, int reqTag, String url, Header[] headers,
			...
			FFHttpRespHandler responseHandler, String reqUrl) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(String url, int reqTag, FFHttpRespHandler responseHandler) {
		put(null, reqTag, url, null, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		put(null, reqTag, url, params, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(Context context, int reqTag, String url, FFRequestParams params,
			FFHttpRespHandler responseHandler) {
		put(context, reqTag, url, paramsToEntity(params), null, responseHandler, getUrlWithQueryString(url, params));
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(Context context, int reqTag, String url, HttpEntity entity,
			String contentType, FFHttpRespHandler responseHandler, String reqUrl) {
		sendRequest(httpClient, httpContext,
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void put(Context context, int reqTag, String url, Header[] headers,
			HttpEntity entity, String contentType,
			FFHttpRespHandler responseHandler, String reqUrl) {
		HttpEntityEnclosingRequestBase request = addEntityToRequestBase(
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void delete(int reqTag, String url, FFHttpRespHandler responseHandler) {
		delete(null, reqTag, url, responseHandler);
	}
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void delete(Context context, int reqTag, String url,
			FFHttpRespHandler responseHandler) {
	 ...
	 *            the response handler instance that should handle the response.
	 */
	public void delete(Context context, int reqTag, String url, Header[] headers,
			FFHttpRespHandler responseHandler) {
		final HttpDelete delete = new HttpDelete(url);
		if (headers != null)
	...
	protected void sendRequest(DefaultHttpClient client,
			...
			Context context, int reqTag, String reqUrl) {
		if (contentType != null) {
			uriRequest.addHeader("Content-Type", contentType);
		}

		Future<?> request = threadPool.submit(new FFHttpRequest(client,
				httpContext, uriRequest, responseHandler, reqTag, reqUrl));
		if (context != null) {
	...
	public static String getUrlWithQueryString(String url, FFRequestParams params) {
		if (params != null) {
	...
	private HttpEntity paramsToEntity(FFRequestParams params) {
