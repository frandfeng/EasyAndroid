...
public abstract class FFBaseCommand implements FFICommand {
	...
	@Override
	public void setRequest(FFRequest request) {
	...
	@Override
	public void setResponse(FFResponse response) {
	...
	@Override
	public void setResponseListener(FFIResponseListener responseListener) {
